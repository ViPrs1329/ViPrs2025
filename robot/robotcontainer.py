...
class RobotContainer:
    ...
    def configureButtonBindings(self) -> None:
        ...
        # self.operator_controller.A(event_loop).onTrue(SetElevatorHeight(self.elevator, "BASE"))
        # self.operator_controller.B(event_loop).onTrue(SetElevatorHeight(self.elevator, "L1"))
        # self.operator_controller.X(event_loop).onTrue(SetElevatorHeight(self.elevator, "L2"))
        # self.operator_controller.Y(event_loop).onTrue(SetElevatorHeight(self.elevator, "L3"))
        
        # Manual elevator control
        # self.operator_controller.leftBumper(event_loop).whileTrue(ManualElevatorControl(self.elevator, 0.5))
        # self.operator_controller.rightBumper(event_loop).whileTrue(ManualElevatorControl(self.elevator, -0.5))
        
        # CORAL controls
        # self.operator_controller.leftTrigger(event_loop).whileTrue(IntakeCoral(self.coral))
        # self.operator_controller.rightTrigger(event_loop).whileTrue(EjectCoral(self.coral))
