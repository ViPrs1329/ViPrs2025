...
* **MUST DO - Need to build in safety mechanisms which prevents the elevator from moving if the in coral sensor is detecting a coral and the out sensor is not. This could mean that the coral is not cleared from the elevator!!!**
