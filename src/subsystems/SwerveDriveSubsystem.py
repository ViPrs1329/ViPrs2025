...
class DriveTrain(commands2.Subsystem):
  def __init__(self) -> None:
    ...
    self.backLeftDriveConfig.setOpenLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.backRightDriveConfig.setOpenLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.frontLeftDriveConfig.setOpenLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.frontRightDriveConfig.setOpenLoopRampRate(constants.driveConsts.rampRate)
