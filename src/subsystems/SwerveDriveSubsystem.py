...
class DriveTrain(commands2.Subsystem):
  def __init__(self) -> None:
    ...
    self.backLeftDriveConfig.openLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.backRightDriveConfig.openLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.frontLeftDriveConfig.openLoopRampRate(constants.driveConsts.rampRate)
    ...
    self.frontRightDriveConfig.openLoopRampRate(constants.driveConsts.rampRate)
